...
#define CONFIG_SYS_PROMPT		"RISE1833> "
 ...
 */
// shlee2302
#define CONFIG_MEM_NVM_BASE		0x1A000000 //0x00000000
#define CONFIG_MEM_NVM_LEN		(256 * 1024) //(96 * 1024)
...
#define CONFIG_SYS_FLASH_BANK1_BASE	0x14000000 /* CS0 */
 ...
 */
// shlee2302
#define CONFIG_LPC18XX_UART_TX_IO_GROUP		9 //15	/* PF */
#define CONFIG_LPC18XX_UART_TX_IO_PIN		5 //10	/* PF.10 = USART0 TXD */
#define CONFIG_LPC18XX_UART_TX_IO_FUNC		7
#define CONFIG_LPC18XX_UART_RX_IO_GROUP		9 //15	/* PF */
#define CONFIG_LPC18XX_UART_RX_IO_PIN		6 //11	/* PF.11 = USART0 RXD */
#define CONFIG_LPC18XX_UART_RX_IO_FUNC		7
