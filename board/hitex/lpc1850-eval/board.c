...
static const struct lpc18xx_pin_config hitex_lpc4350_iomux[] = {
...
#else
	{{0x1, 15}, LPC18XX_IOMUX_CONFIG(3, 0, 1, 1, 1, 1)},
	{{0x0,  0}, LPC18XX_IOMUX_CONFIG(2, 0, 1, 1, 1, 1)},
	{{0x1, 16}, LPC18XX_IOMUX_CONFIG(7, 0, 1, 1, 1, 1)},
	{{0x0,  1}, LPC18XX_IOMUX_CONFIG(6, 0, 1, 1, 0, 1)},
	{{0x1, 19}, LPC18XX_IOMUX_CONFIG(0, 0, 1, 1, 1, 1)},
	{{0x1, 18}, LPC18XX_IOMUX_CONFIG(3, 0, 1, 1, 0, 1)},
	{{0x1, 20}, LPC18XX_IOMUX_CONFIG(3, 0, 1, 1, 0, 1)},
	{{0x1, 17}, LPC18XX_IOMUX_CONFIG(3, 0, 1, 1, 1, 1)},
	{{0x7,  7}, LPC18XX_IOMUX_CONFIG(6, 0, 1, 1, 0, 1)},
#endif
	...
	// shlee2302 130506 : nor flash 4M -> 8M
	/* PE.4 = A22 - NOR */
	...
	lpc18xx_bootstrap_from_norflash(void)
{
	...
	else if(lpc18xx_get_boot_source() == LPC18XX_BOOTSRC_SPIFI){
		/*
		 * Copy U-Boot image from SPIFI_NOR flash to internal SRAM
		 */
		dest = &_mem_nvm_base;
		src = (void *)(CONFIG_SYS_FLASH_BANK1_BASE +
			CONFIG_LPC18XX_NORFLASH_IMAGE_OFFSET);
